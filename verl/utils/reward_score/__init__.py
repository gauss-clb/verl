...
def _default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None):
    if data_source == "openai/gsm8k":
        ...
        res = math_func.compute_score(solution_str, ground_truth)
        ...
        from . import math_rllm

        res = math_rllm.rllm_math_reward_fn(data_source, solution_str, ground_truth, extra_info)
    else:
